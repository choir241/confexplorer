...
description: "The world's premiere global event for all things involving flutter and android development."
  },
  {
    ...
    description: "The largest open source, tech, and/or web conference in the east coast."
  },
  {
    name: "Epic Web Dev",
    city: "Salt Lake City",
    ...
    description: "Join other full stack devs from all around the world to collaborate on present and future state of the art of building the best user/dev experience possible."
  },
  {
    name: "React Miami",
    city: "Miami",
    ...
    description: "Explore the latest in the React ecosystem with 500 similar-minded devs while soaking in the Miami sunny rays!"
  },
  {
    name: "Render ATL",
    city: "Atlanta",
    ...
    description: "Fun carnival and amazing opportunities at RenderATL for tech professionals to sharpen your skills!"
  },
  {
  ...
  img: CommitYourCodeImg,
    ...
    description: "A conference that focuses on giving back to the community, where all the ticket sales go to charity."
  },
];
